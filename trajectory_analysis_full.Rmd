...
output: 
  html_document: 
    ...
    toc_float: yes
    number_sections: yes
    code_folding:showgbmt_fit_total
      bootswatch: flatly
    highlight: kate
...
Para operaciones futuras, se crea temporalmente un falso `SALID1` que permitirá tener una identificación única por ciudad y posteriormente unificar los datos.

> **Es aquí donde preferentemente se debería adicionar y/o corregir con la información correcta.**
...
fs::dir_create("02_output/plots/paper/line_plots_std/")
fs::dir_create("02_output/plots/paper/line_plots/")
fs::dir_create("02_output/plots/paper/stacked_bar_plots/")
fs::dir_create("02_output/plots/paper/bar_plots/")

# Aplicar la función a cada una de las últimas cuatro columnas
save_plots(gbmt_fit_plots$line_plot_std, "02_output/plots/line_plots_std/ineplot", gbmt_fit_final$x_names, gbmt_fit_final$ng)
save_plots(gbmt_fit_plots$line_plot, "02_output/plots/line_plots/lineplot", gbmt_fit_final$x_names, gbmt_fit_final$ng)
save_plots(gbmt_fit_plots$stacked_bar_plot, "02_output/plots/stacked_bar_plots/stackedbarplot", gbmt_fit_final$x_names, gbmt_fit_final$ng)
save_plots(gbmt_fit_plots$bar_plot, "02_output/plots/bar_plots/barplot", gbmt_fit_final$x_names, gbmt_fit_final$ng)
